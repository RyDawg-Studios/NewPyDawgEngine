...
from engine.debug.debugObject import TestActor, TestPlayer
...
class StressLevel(Level):
    def __init__(self, man, pde) -> None:
        ...
        for obj in range(0, 50):
            self.objectManager.objects["Enemy" + str(obj)] = TestActor(man=self.objectManager, pde=pde, position=[random.randint(0, 700), random.randint(0,500)])